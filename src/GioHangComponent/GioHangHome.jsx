...
export default class GioHangHome extends Component {
    ...
    render() {
        let { id, image, name, price } = this.state.shoesdetail;
        return (
            <div className='container'>
                <div className="row">
                    ...
                    <Produclist renderview={this.renderview}  ShoesArray={this.ShoesArray}></Produclist>
                </div>
                
               <GiohangModel shoesdetail={this.state.shoesdetail}></GiohangModel>
